import argparse
import torch
from CoMatch.WideResNet import WideResnet
from CoMatch.datasets.custom import get_test_loader
from CoMatch.utils import AverageMeter, accuracy
...
def main():
    ...
    parser.add_argument('--saved-model', default='CoMatch/redtheme/1/CoMatch/checkpoint_90.pth', type=str, help='use saved model')
